...
($\color{red}{\text{The clustering results file contains the original dataset information and a new column called 'label/class' which indicates the clustering results.}}$)
